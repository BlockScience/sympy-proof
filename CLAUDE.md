...
Nine modules in a flat package:

| Module | Purpose |
|--------|---------|
| `types.py` | `SympyExpr`, `SympyBoolean` type aliases |
| `models.py` | All Pydantic models: Axiom, AxiomSet, Hypothesis, Lemma, ProofScript, ProofBundle, Disproof |
...
| `verification.py` | `verify_lemma`, `verify_proof` — three-strategy dispatch |
...
| `bundle.py` | `seal`, `disprove`, `check_consistency` — bundle operations |
